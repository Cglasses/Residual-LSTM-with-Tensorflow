...
class LSTM():
    ...
    def build_lstm_cell1(self, cell_code):
        ...
        s2, s2_vars = inside_LSTM_nn(100, 100, 100, 100, self.nn1_inside_LSTM_outputfeature_num, '1', cell_code)
        s3, s3_vars = inside_LSTM_nn(100, 100, 100, 100, self.nn2_inside_LSTM_outputfeature_num, '2', cell_code)
        s4, s4_vars = inside_LSTM_nn(100, 100, 100, 100, self.nn3_inside_LSTM_outputfeature_num, '3', cell_code)
        s4 = tf.tanh(s4, name='tanh_s4_' + cell_code)
        s5, s5_vars = inside_LSTM_nn(100, 100, 100, 100, self.nn4_inside_LSTM_outputfeature_num, '4', cell_code)
